...
import { formatDate, formatFieldName, formatFieldValue, formatFileSize } from "../../utils/dashboardFormatters";
  ...
  useEffect(() => {
    ...
    Promise.all([getAdminApplicationById(id), getAdminExperts({ status: "active", limit: 100 })])
      .then(([app, people]) => {
        ...
        setAssignment((current) => ({ ...current, assignmentType: app.application.assignmentType || "none", assignedExpertId: app.application.assignedExpertId || app.application.assignedRetailerId || "", assignedPartnerId: app.application.assignedPartnerId || "" }));
      })
