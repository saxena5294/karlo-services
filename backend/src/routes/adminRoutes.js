...
router.patch("/customers/:id/status", controller.updateCustomerAccountStatus);
router.get("/approvals/partners", controller.pendingPartnerApprovals);
router.get("/approvals/experts", controller.pendingExpertApprovals);
router.get("/experts", controller.listExperts);
router.get("/experts/:id", controller.expertDetails);
router.post("/experts", controller.createExpert);
router.patch("/experts/:id", controller.updateExpert);
router.patch("/experts/:id/decision", controller.decideExpert);
...
router.patch("/partners/:id/decision", controller.decidePartner);
