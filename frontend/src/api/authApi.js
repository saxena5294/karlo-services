...
import { clerkSessionHeaders, normalizeCurrentUserResponse } from "../auth/authHeaders";

export const getCurrentProfile = async (token) => normalizeCurrentUserResponse((await API.get(
  "/auth/me",
