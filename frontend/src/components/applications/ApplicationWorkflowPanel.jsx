...
const ApplicationWorkflowPanel = ({ applicationId, canComment = false, defaultVisibility = "internal" }) => {
  ...
  return <div className="space-y-6">
    ...
    <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      ...
      <article className="rounded-2xl border bg-white p-4"><p className="text-xs text-slate-500">Document progress</p><strong className="mt-1 block">{checklist.verified} verified · {checklist.pending} pending</strong><p className="text-xs text-slate-500">{checklist.missing.length} missing · {checklist.rejected} rejected · {checklist.expired || 0} expired</p></article>
    </section>
